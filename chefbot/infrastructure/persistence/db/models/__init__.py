...
These were previously imported from the `chefbot.models` package. That alias is
still available for backward compatibility, but new code should import from
`chefbot.infrastructure.persistence.db.models` to make the intent (database layer) explicit.
"""
