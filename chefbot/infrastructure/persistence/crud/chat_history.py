...
from chefbot.infrastructure.persistence.db.models.chat_history import ConversationHistorySnapshot
from chefbot.interfaces.http.models.chat_history import ConversationHistorySnapshotCreate
