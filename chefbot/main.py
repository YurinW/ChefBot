"""
ChefBot FastAPI application entry point.
"""
...
from chefbot.application.services.lightrag_service import get_lightrag_service
from chefbot.config import settings
from chefbot.infrastructure.core import configure_logging
from chefbot.infrastructure.core.database import Base, engine
from chefbot.interfaces.http import knowledge_router, lightrag_router
from chefbot.interfaces.http.knowledge_router import get_neo4j_qa_service
from chefbot.interfaces.http.v1 import api_router as api_v1_router
...
async def startup_event() -> None:
    ...
    import chefbot.infrastructure.persistence.db.models  # noqa: F401 - Import all models to register them with Base
