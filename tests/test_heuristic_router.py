...
if __name__ != "__main__" and not os.getenv("CHEFBOT_RUN_INTEGRATION_TESTS"):
    import pytest

    pytest.skip(
        "Integration-style heuristic router script (set CHEFBOT_RUN_INTEGRATION_TESTS=1 to enable in pytest).",
...
from chefbot.application.agents.lg_states import InputState
from chefbot.application.agents.lg_builder import graph
from chefbot.application.agents.utils import new_uuid
